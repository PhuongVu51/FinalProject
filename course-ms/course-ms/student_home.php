...
<body>
         ...
         <!-- Search Bar -->
            ...
            <div class="quick-stats">
                ...
                <a href="student_scores.php" class="stat-card">
                    <div class="stat-icon scores"><i class="fa-solid fa-star"></i></div>
            ...
            <div style="display:grid; grid-template-columns: 2fr 1fr; gap:24px;">
                ...
                <div>
                    ...
                    <div class="card" style="text-align:center;">
                        <div style="width:60px; height:60px; background:#FFF9C4; color:#F9A825; border-radius:50%; display:flex; align-items:center; justify-content:center; margin:0 auto 15px; font-size:24px;">
    ...
    <style>
        ...
        .stat-icon.scores { background: #FFF9C4; color: #F9A825; }
        .stat-number {
            font-size: 32px;
            font-weight: 700;
            color: #333;
