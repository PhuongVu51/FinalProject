...
if(isset($_SESSION['user_id'])) {
    ...
    elseif($role == 'student') header("Location: student/student_home.php");
    elseif($role == 'admin') header("Location: admin/home.php");
    ...
    if(empty($username) || empty($password)) {
        ...
        if(mysqli_num_rows($res) == 1) {
            ...
            if($user['role'] !== $selected_role) {
                ...
                loadSubId($link, $user); // Hàm lấy teacher_id hoặc student_id
                ...
                if($user['role'] == 'teacher') {
                    ...
                    header("Location: student/student_home.php"); // Hoặc student_dashboard.php tùy bạn
                } elseif($user['role'] == 'admin') {
                    header("Location: admin/home.php");
                } else {
                    header("Location: home.php"); // Mặc định
                }
                exit;
            }
        } else {
...
<head>
    ...
    <title>Đăng nhập | Teacher Bee</title>
    ...
    <div class="w-full h-screen flex overflow-hidden bg-white shadow-2xl rounded-none lg:rounded-2xl lg:h-[85vh] lg:w-[90vw] xl:w-[1200px] lg:m-8">
            ...
            <div class="z-10 flex flex-col justify-center h-full">
                ...
                <div class="w-full h-64 bg-white/60 backdrop-blur-sm rounded-2xl border-2 border-white/50 flex items-center justify-center shadow-soft">
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-400 font-medium">Teacher & Student Platform</p>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full lg:w-1/2 bg-white p-8 md:p-12 lg:p-16 flex flex-col justify-center relative">
            ...
            <form method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    <label class="text-sm font-semibold text-dark-900">Tên đăng nhập</label>
                    <div class="input-group relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i class="ph ph-user text-gray-400 text-xl transition-colors"></i>
                        </div>
                        <input type="text" name="username" class="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-dark-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-honey-500/20 focus:border-honey-500 transition-all" placeholder="Nhập username" required>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="forgot_password.php" class="text-xs font-bold text-honey-600 hover:underline">Quên mật khẩu?</a>
                </div>
