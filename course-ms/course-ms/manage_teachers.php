        ...
        <div style="display:grid; grid-template-columns: 1fr 2fr; gap:24px">
            <div class="card">
                <div class="card-header">
                    <h3><i class="fa-solid fa-user-plus" style="color:#F59E0B"></i> Thêm Giáo Viên</h3>
                </div>
                        ...
                        <tr>
                            <td>
                                <div style="display:flex; align-items:center; gap:10px;">
                                    <div style="width:32px; height:32px; background:#EFF6FF; color:#3B82F6; border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:13px;">
                                        <i class="fa-solid fa-chalkboard-user"></i>
                                    </div>
                                    <b style="color:#0F172A;"><?php echo $r['full_name']; ?></b>
                                </div>
                            </td>
                            <td style="color:#64748B"><?php echo $r['email']; ?></td>
                            <td align="center">
                                <a href="?del=<?php echo $r['uid']; ?>" onclick="return confirm('Xóa giáo viên này?')" class="btn-delete" title="Xóa">
