<?php
// SỬA ĐƯỜNG DẪN: Thêm ../ để tìm thấy file ở thư mục cha
...
<body class="bg-dark-100 min-h-screen font-sans text-dark-900 pb-20">
    ...
    <div class="bg-white shadow-sm h-16 flex items-center justify-between px-6 fixed top-0 w-full z-20">
        <div class="flex items-center gap-3">
            <a href="manage_exams.php" class="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200"><i class="ph-bold ph-arrow-left"></i></a>
    ...
    <script>
        ...
        function toggleQType(select, index) {
            ...
            if (val === 'essay') { optsDiv.classList.add('hidden'); essayDiv.classList.remove('hidden'); } 
